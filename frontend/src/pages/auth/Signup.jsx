        ...
        >
          ...
          <div>
            <div className="mb-8">
              ...
              <p className="text-neutral-600">Get started with your 15-day free trial</p>
            </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      required
                      className="w-full border border-neutral-300 rounded-lg px-4 py-3 text-neutral-900 placeholder:text-neutral-400 focus:outline-none focus:border-neutral-900 focus:ring-1 focus:ring-neutral-900 transition-all"
                    />
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2 pt-2">
                  ...
                  <label htmlFor="terms" className="text-sm text-neutral-600">
                    I agree to the <Link to="/terms" className="text-neutral-900 font-medium hover:underline">Terms of Service</Link> and <Link to="/privacy" className="text-neutral-900 font-medium hover:underline">Privacy Policy</Link>
                  </label>
                </div>
